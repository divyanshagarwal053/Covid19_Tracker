...
import com.ferid.app.a19tacker.Adapters.CountryAdapter;
...
public class CountryData extends AppCompatActivity {
    ...
    private void Init() {
        swipeRefreshLayout = findViewById(R.id.country_swipe_refresh_layout);
        et_search = findViewById(R.id.country_search);

        rv_country = findViewById(R.id.country_recyclerview);
        ...
        countryAdapter = new CountryAdapter(CountryData.this, countryModelArrayList);
